...
public class VoiceCommandCreator {
    ...
    public static void create(String commandName, String commandSpoken, String wakeWord, boolean isMaster, String argKey, String argValue, long timestamp, String medium, long transcriptId, VoiceCommandRepository repo) {
        /*
        ...
        VoiceCommandEntity voiceCommand = new VoiceCommandEntity(commandName, commandSpoken, wakeWord, isMaster, argKey, argValue, timestamp, medium, transcriptId);
